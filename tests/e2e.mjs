...
await playCorrect(3);
console.log('   segmentos completados tras 3 aciertos:', await page.locator('.wj-hud__step.is-done').count(), '| actual:', await page.locator('.wj-hud__step.is-current').count());
await shot('03d-nivel1-progreso');
await playCorrect(7);
